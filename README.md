# CFA Level III Review Notes

This repository contains concise, exam-oriented review notes organized under the CFA Level III curriculum.
...
- Equity Portfolio Management pathway
- Fixed-Income Portfolio Management pathway
- Trading Strategy and Execution pathway
- Institutional Investor Portfolio Management pathway

The HTML files include a collapsible left-side table of contents for rapid pre-exam review. Course categories are the only fixed navigation hierarchy; the immediate parent framework of each knowledge point is explained inside the article so that later additions remain flexible.
